...
void raop_rtp_mirror_init_legacy_aes(raop_rtp_mirror_t *raop_rtp_mirror,
...
int raop_rtp_mirror_start_fd(raop_rtp_mirror_t *raop_rtp_mirror,
                             int stream_fd, uint8_t show_client_FPS_data);
